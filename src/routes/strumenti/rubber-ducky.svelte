...
<section>
  ...
  <p>
    Prendiamo il nostro Arduino UNO e carichiamo lo sketch presente nella
    repository
  </p>
  <div uk-lightbox>
  ...
  <p>
    Ora flashiamo attraverso Atmel Flip(Windows) oppure dfu-programmer(Linux e
    Mac OS) il seguente firmware per far si che il nostro Arduino diventi una
    chiavetta
  </p>
  <a
    style="color:white;"
  ...
  <p>
    Con il seguente sketch quando noi andremo ad attacare l'Arduino al PC verrà
    aperta una powershell che scarica un programma che fa crashare il SO senza
    bisogno di permessi di amministratore
  </p>
  <p>
    Se volete modificare lo sketch, la funzione Keypress preme dei tasti sulla
    tastiera mentre la funzione Keystring prende come parametro una stringa e
    digita il testo nella stringa
  </p>
  <p>
    Se volete trasformare il vostro Duckino in un normale Arduino flashate il
    seguente firmware con la stessa procedura di prima, cambiando il nome del
    file sul comando flash
  </p>
  <a
    style="color:white;"
