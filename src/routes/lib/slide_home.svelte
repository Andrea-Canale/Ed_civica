...
>
  <ul class="uk-slideshow-items">
    ...
    <li>
      ...
      >
        <h3 class="uk-margin-remove">Truffe Online</h3>
        <p class="uk-margin-remove">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
      </div>
    ...
    <li>
      ...
      >
        <h3 class="uk-margin-remove">Furti d'indentità</h3>
        <p class="uk-margin-remove">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
      </div>
    ...
    <li>
      ...
      >
        <h3 class="uk-margin-remove">Rubber Ducky</h3>
    ...
    <li>
      ...
      <div
        class="uk-position-bottom uk-position-medium uk-text-center uk-light"
      >
        <h3 class="uk-margin-remove">Raspberry</h3>
        <p class="uk-margin-remove">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
      </div>
    ...
    <li>
      ...
      <div
        class="uk-overlay uk-overlay-default uk-position-bottom-right uk-position-small"
      >
        <h3 class="uk-margin-remove">LAN Turtle</h3>
        <p class="uk-margin-remove">Lorem ipsum dolor sit amet.</p>
      </div>
    </li>
    <li>
    ...
    <li>
      ...
      <div
        class="uk-position-bottom uk-position-medium uk-text-center uk-light"
      >
        <h3 class="uk-margin-remove">Sniffing</h3>
        <p class="uk-margin-remove">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
      </div>
    ...
    <li>
      ...
      <div
        class="uk-overlay uk-overlay-default uk-position-bottom-right uk-position-small"
      >
        <h3 class="uk-margin-remove">Reati Informatici</h3>
        <p class="uk-margin-remove">Lorem ipsum dolor sit amet.</p>
      </div>
    </li>
    <li>
    ...
    <li>
      ...
      <div
        class="uk-position-bottom uk-position-medium uk-text-center uk-light"
      >
        <h3 class="uk-margin-remove">DDOS</h3>
        <p class="uk-margin-remove">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit.
        </p>
      </div>
